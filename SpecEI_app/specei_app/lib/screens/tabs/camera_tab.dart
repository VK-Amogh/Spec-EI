...
class _CameraTabState extends State<CameraTab>
  ...
  final PermissionStateService _permissionService = PermissionStateService();
  ...
  void initState() {
    ...
    // Check if camera is enabled before initializing
    if (_permissionService.isCameraEnabled) {
      _initializeCamera();
    }
  }
  ...
  VoidCallback? _getCaptureTapHandler() {
    switch (_selectedMode) {
      ...
      case 2: // Scan (same as photo for now)
        return (_isCameraInitialized && !_isCapturing) ? _capturePhoto : null;
      case 1: // Video
